...
public class EmpresarioUpdateValidator implements ConstraintValidator<EmpresarioUpdate, EmpresarioDTO> {
	...
	@Override
	public void initialize(EmpresarioUpdate ann) {
	}

	@Override
	public boolean isValid(EmpresarioDTO objDto, ConstraintValidatorContext context) {
