...
public class JogadorUpdateValidator implements ConstraintValidator<JogadorUpdate, JogadorDTO> {
	...
	@Override
	public void initialize(JogadorUpdate ann) {
	}

	@Override
	public boolean isValid(JogadorDTO objDto, ConstraintValidatorContext context) {
